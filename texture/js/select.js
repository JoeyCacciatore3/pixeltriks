...
GF.select = (function () {
  ...
  function emit() { viz = [null, null]; maskCnv = null; cachedCount = -1; listeners.forEach(f => f()); }
  ...
  return { onChange, ensure, clear, selectAll, invert, get, dims, has, count, wand,
           selectBackground, feather, grow, contract, bounds, vizCanvas,
           maskCanvas, fromAlphaCanvas, combine };
})();
